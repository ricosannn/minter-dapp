const contractAddress = "0x4167d6A00ca5423C43A503f3e21656Bc6A047a0B"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the AlejandroAndFriends NFT !!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'AlejandroAndFriends is the real shit bro. Come mint one bish! 😎';
...
const button_public_mint = "Mint Your AlejandroAndFriends NFT!";
